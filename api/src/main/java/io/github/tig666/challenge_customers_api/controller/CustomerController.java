...
public class CustomerController {
    ...
    @GetMapping("/find")
    public ResponseEntity<ResponseGenericDTO> getCustomer(@RequestParam("documentNumber") Long documentNumber) {
    ...
    @PostMapping
    public ResponseEntity<ResponseGenericDTO> createCustomer(@Valid @RequestBody CustomerDTO customerDTO) {
    ...
    @PutMapping
    public ResponseEntity<ResponseGenericDTO> updateCustomer(@Valid @RequestBody CustomerDTO customerDTO) {
    ...
    public ResponseEntity<ResponseGenericDTO> updateCustomerCustomer(@PathVariable Long documentNumber) {
